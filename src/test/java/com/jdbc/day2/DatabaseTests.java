...
public class DatabaseTests {
   ...
   final String DB_URL = "jdbc:oracle:thin:@54.161.128.39:1521:xe";
   ...
   @Test
    public void getEmployeesData() throws SQLException {
       ...
       //ResultSet.CONCUR_READ_ONLY - creates ResultSet object that can be updated but can be read
...
//           employeeIDsMap.put("employee_id", resultSet.getInt("employee_id"));
